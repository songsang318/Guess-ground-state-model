...
class NNVM:
    ...
    def backward(self, loss_func, eps=1e-4):
        ...
        delta = dL_dout * self._sigmoid_derivative(self.activations[-1])
        ...
        for l in range(self.num_layers - 1, -1, -1):
            ...
            if l > 0:
                delta = np.dot(delta, self.weights[l].T) * self._sigmoid_derivative(a_prev)
